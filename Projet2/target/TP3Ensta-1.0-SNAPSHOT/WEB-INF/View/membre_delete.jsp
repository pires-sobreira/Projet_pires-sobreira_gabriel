  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du membre n°${membre.id}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer la fiche de ${membre.firstName} ${membre.lastName} ?</p> <!-- TODO : remplacer prenomDuMembre et nomDuMembre par les valeurs correspondantes -->
